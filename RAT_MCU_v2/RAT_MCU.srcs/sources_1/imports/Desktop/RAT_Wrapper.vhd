...
entity RAT_wrapper is
    Port ( LEDS     : out   STD_LOGIC_VECTOR (7 downto 0);
           ...
           LDR      : in    STD_LOGIC_VECTOR (2 downto 0);
           RST      : in    STD_LOGIC;
           CLK  	: in    STD_LOGIC;
...
architecture Behavioral of RAT_wrapper is
   ...
   CONSTANT LDR_ID        : STD_LOGIC_VECTOR (7 downto 0) := X"10";
   CONSTANT RNG         : STD_LOGIC_VECTOR (7 downto 0) := X"11";
   -------------------------------------------------------------------------------
   ...
   signal s_RNG : std_logic_vector(7 downto 0);
   ...
   signal s_LDR      : std_logic_vector(7 downto 0);
...
begin
   ...
   begin
      ...
      elsif s_port_id = LDR_ID then
        s_input_port <= s_LDR;
      elsif s_port_id <= RNG then
        s_input_port <= s_RNG;
   	  else
    	s_input_port <= x"00";
      end if;
